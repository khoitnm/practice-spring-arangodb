package org.tnmk.practicespringarangodb.pro02auditablefields.common.infrastructure.mongodb;
...
public class MongoTLSConfig {
    ...
    private static X509Certificate createCaCertificate(String pemFileClassPath) throws CertificateException, IOException {
        try (InputStream is = new ClassPathResource(pemFileClassPath).getInputStream()) {
